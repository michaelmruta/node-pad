...
var RED = (function() {
    ...
    function buildMainMenu() {
        var menuOptions = [];
        menuOptions.push({id:"menu-item-dashboard",
            label: RED.settings.theme("menu.menu-item-dashboard.label",RED._("menu.label.dashboard")),
            href: RED.settings.theme("menu.menu-item-dashboard.url","/ui"),
            target: RED.settings.theme("menu.menu-item-dashboard.target","_parent"),
        });
